...
public class Constants {
	...
	public static final int GAME_HARD = 22;
	public static final int GAME_CHARD1 = 23;
	public static final int GAME_CHARD2 = 24;
	public static final int GAME_CHARD3 = 25;
	public static final int GAME_CHARD4 = 26;
	public static final int GAME_CHARD5 = 27;
	
	/** 设置游戏模式 */
	public static final int MODE_SINGLE = 31;
	public static final int MODE_FIGHT = 32;
	public static final int MODE_TOGETHER = 33;
